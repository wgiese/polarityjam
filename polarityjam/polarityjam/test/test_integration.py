...
class TestIntegration(TestCommon):
    ...
    def test_run(self):
        ...
        self.assertEqual(67, df.shape[1])
    ...
    def test_run_stack(self):
        ...
        # number of features should not change
        self.assertEqual(67, df1.shape[1])
        self.assertEqual(67, df2.shape[1])
    ...
    def test_run_stack_no_golgi(self):
        ...
        # number of features should not change
        self.assertEqual(62, df1.shape[1])
        self.assertEqual(62, df2.shape[1])
        self.assertEqual(62, df3.shape[1])
