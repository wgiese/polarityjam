...
def run(args):
    """Entry point for running feature extraction."""
    set_figure_dpi()
...
def run_stack(args):
    """Entry point from running feature extraction as stack."""
    set_figure_dpi()
...
def run_key(args):
    """Entry point for running feature extraction with a key file."""
    set_figure_dpi()
